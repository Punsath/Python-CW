...
def progression_outcome(pass_credit,defer_credit,fail_credit):
    ...
    if pass_credit == 80 and defer_credit == 20:
    ...
    if pass_credit == 60 and fail_credit <=60:
        print('Do not progress-module retriever')
       
        
    if pass_credit == 40 and defer_credit <=60:
        print('Do not progress-module retriever')
    elif pass_credit == 40 and fail_credit == 80:
        print('Exclude')
    

    if pass_credit == 20 and fail_credit <= 60:
        print('Do not progress-module retriever')
    elif pass_credit == 20 and fail_credit >=80:
        print('Exclude')
   

    if pass_credit == 0 and fail_credit <= 60:
        print('Do not progress-module retriever')
    elif pass_credit == 0 and fail_credit >= 80:
        print('Exclude')
